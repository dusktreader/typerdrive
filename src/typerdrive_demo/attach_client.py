...
def demo_1__attach_client__use_base_url_from_settings():
    ...
    def report(ctx: typer.Context, swapi: TyperdriveClient):  # pyright: ignore[reportUnusedFunction]
...
def demo_3__attach_client__multiple_clients():
    ...
    def report(ctx: typer.Context, people: TyperdriveClient, planets: TyperdriveClient, id: int = 1):  # pyright: ignore[reportUnusedFunction]
        person_id = randint(1, 10)
