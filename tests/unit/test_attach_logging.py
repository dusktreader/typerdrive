"""
Tests for `attach_logging` decorator.
"""

from tests.unit.helpers import match_output
from tests.unit.logging_string_annotation_module import (
...
class TestStringAnnotations:
    """
    Verify that `attach_logging` works correctly when the decorated function
    ...
    def test_logging_attached_with_string_annotations(self):
        """Logging manager is attached correctly when annotations are strings."""
    ...
    def test_manager_parameter_injected_with_string_annotations(self):
        """LoggingManager parameter is injected correctly when annotations are strings."""
